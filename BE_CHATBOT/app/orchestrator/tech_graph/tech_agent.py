...
from .tools.customer_tools import recommend_system, get_device_details, order_purchase, cancel_order, track_order,book_appointment,track_appointment,cancel_appointment
...
tech_safe_tools = [recommend_system, get_device_details, track_order,track_appointment]
tech_sensitive_tools = [order_purchase, cancel_order,book_appointment,cancel_appointment]
